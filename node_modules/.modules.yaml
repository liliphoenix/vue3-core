...
hoistedDependencies:
  ...
  /@gitmoji/commit-types/1.1.5:
    '@gitmoji/commit-types': private
  /@gitmoji/gitmoji-regex/1.0.0:
    '@gitmoji/gitmoji-regex': private
  /@gitmoji/parser-opts/1.4.0:
    '@gitmoji/parser-opts': private
  ...
  /commitlint-plugin-gitmoji/2.2.6:
    commitlint-plugin-gitmoji: private
  /commondir/1.0.1:
    commondir: private
  /concat-map/0.0.1:
    concat-map: private
...
pendingBuilds: []
prunedAt: Sat, 27 Apr 2024 08:10:34 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@rollup/rollup-win32-ia32-msvc/4.16.4
  - /@rollup/rollup-win32-x64-msvc/4.16.4
storeDir: /Users/bobi/Library/pnpm/store/v3
